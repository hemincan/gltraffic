...
<%
	...
	if (indentity == null || !"管理员".equals(indentity.toString())) {
		response.sendRedirect("adminsystem/fail.jsp");
	} else {
...
<body>
	...
	<div id="rightcontent">
		...
		<div style="display: none;">
			<s:form action="newarticle" namespace="/admin" name="newtopic_form"
				method="post" enctype="multipart/form-data">
				<s:textfield label="文章" name="article.articleTiltle" id="tiltle"></s:textfield>
				<s:textfield label="文章" name="article.articleContent" id="content"></s:textfield>
