...
<body>
	...
	<div id="rightcontent">
		<h2>爆光类型数统计(${type })</h2>
		<a href="admin/typestatistic?type=today">今天</a> <a
			href="admin/typestatistic?type=week">最近一周</a> <a
			href="admin/typestatistic?type=month">最近一月</a> <a
			href="admin/typestatistic?type=year">最近一年</a> 
