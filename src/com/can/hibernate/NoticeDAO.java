...
public class NoticeDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String NOTICE_TILTLE = "noticeTiltle";
	...
	public List findByExample(Notice instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.can.hibernate.Notice")
	...
	public List findByNoticeTiltle(Object noticeTiltle) {
		return findByProperty(NOTICE_TILTLE, noticeTiltle);
	}
	...
	public List findByNoticeReaded(Object noticeReaded) {
		return findByProperty(NOTICE_READED, noticeReaded);
	}

	public List findByNoticeState(Object noticeState) {
		return findByProperty(NOTICE_STATE, noticeState);
	}
