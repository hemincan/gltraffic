...
public class CommentDAO extends BaseHibernateDAO {
	...
	public static final String COMMENT_STATE_QUOTE = "commentStateQuote";
	...
	public List findByExample(Comment instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.can.hibernate.Comment")
	...
	public List findByCommentState(Object commentState) {
		return findByProperty(COMMENT_STATE, commentState);
	}

	public List findByCommentStateQuote(Object commentStateQuote) {
		return findByProperty(COMMENT_STATE_QUOTE, commentStateQuote);
	}
