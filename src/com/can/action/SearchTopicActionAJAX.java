...
public class SearchTopicActionAJAX extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		String hql = "from Topic as t where t.topicType <> '公告' and t.topicContent like '%"+words+"%' order by t.topicLastUpdatetime desc";
