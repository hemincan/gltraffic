...
/*
 * 用户的topicid,，与Mytopicid虽然大概都相同，但是说不定有不同的需求
 * 
 */
public class UserTopicActionAJAX extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Query query = se.createQuery("from Topic as t where t.user.userId='"
				+ userid + "' order by t.id desc");
